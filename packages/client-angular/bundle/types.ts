...
export interface Config<T extends ClientOptions = ClientOptions>
   ...
   * @default 'auto'
   */
  parseAs?: 'arrayBuffer' | 'auto' | 'blob' | 'formData' | 'json' | 'text';
  /**
 ...
 * `setConfig()`. This is useful for example if you're using Angular's
 * dependency injection to ensure your client always has the correct values.
 */
